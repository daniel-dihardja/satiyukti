  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-6 pt-10 pb-24 md:px-10 md:pt-16 md:pb-28">
      ...
      <p className="mb-12 text-base leading-relaxed text-muted-foreground md:leading-loose">
        ...
        tradition. It contains 163 verses — including 112 precise, self-contained
        techniques called <em>dharanas</em>. Not doctrine or belief,
        but direct methods for touching the nature of consciousness itself.
      </p>
